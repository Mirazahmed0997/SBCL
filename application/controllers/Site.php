...
class Site extends CI_Controller {
	...
	public function view($uri)
	{
		...
		if ($uri=='contact') $page="contact";
		else if ($uri=='gallery') $page="gallery";
		else if ($uri=='result') $page="result";
		else if ($uri=='download') $page="download";
		else if ($uri == "our_info") $page = "info_details";
		else $page="pageload";
