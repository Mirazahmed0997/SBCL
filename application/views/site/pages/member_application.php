    ...
    <form action="<?php echo base_url('member_register'); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid-container">
            ...
            <div class="form-group">
                ...
                <input type="number" name="nid" id="digit-input" inputmode="numeric" pattern="[0-9]{10}|[0-9]{13}|[0-9]{17}|[0-9]{19}" title="অনুগ্রহ পূর্বক ১০, ১৩, ১৭ অথবা ১৯ টি সংখ্যা দিন" placeholder="জাতীয় পরিচয়পত্র নম্বর..." required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="branch_designation" placeholder="সমিতিতে পদবী..." required>
            </div>
            <div class="form-group">
                <label>সমিতি জেলা</label>
                <input type="text" name="branch_district" placeholder="সমিতি জেলা..." required>
            </div>
            <div class="form-group">
                <label>সমিতি নাম</label>
                <input type="text" name="branch_work_name" placeholder="সমিতি নাম..." required>
            </div>
            <div class="form-group">
                <label>টাকার পরিমাণ</label>
                <input type="number" name="paid_amount" placeholder="সমিতি নাম..." required>
            </div>
            <div class="form-group">
                <label>পরিশোধের রশিদ নম্বর</label>
                <input type="text" name="voucher_no" placeholder="পরিশোধের রশিদ নম্বর..." required>
            </div>
            <div class="form-group">
        ...
        <div class="grid-container">
            <div class="form-group">
                ...
                <input type="text" name="branch_name" placeholder="নিবন্ধিত সমিতির নাম" required>
            </div>
            <div class="form-group">
                <label>সমিতির মোবাইল নম্বর</label>
                <input type="tel" name="branch_mobile_number" pattern="^\d{11}$" placeholder="017XXXXXXXX" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>সভাপতি</label>
                <input type="text" name="branch_chairman" required>
            </div>
            <div class="form-group">
                <label>সম্পাদক</label>
                <input type="text" name="branch_secretary" required>
            </div>
            <div class="form-group">
                <label>সমিতির রেজিষ্ট্রেশন নং</label>
                <input type="text" name="branch_registration_no" required>
            </div>
            <div class="form-group">
                <label>তারিখ</label>
                <input type="date" name="branch_registration_date" required>
            </div>
            <div class="form-group">
                <label>সমিতির শ্রেনি</label>
                <input type="text" name="branch_class" required>
            </div>
            <div class="form-group">
                <label>টাইপ</label>
                <select name="branch_type" required>
                    <option value="">নির্বাচন করুন</option>
            ...
            <div class="form-group">
                ...
                <input type="number" name="branch_member" required>
            </div>
            <div class="form-group">
                <label>সমিতির সদস্য নির্বাচনী ও কর্ম এলাকা</label>
                <input type="text" name="branch_working_area" required>
            </div>
        </div>
