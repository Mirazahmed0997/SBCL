    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('Admin/gallery_update', 'role="form" id="fromvalid"'); ?>
                    <input type="hidden" name="id" value="<?php echo $gallery->id; ?>">
                    <input type="hidden" name="album_id" value="<?php echo $gallery->gallery_album_id; ?>">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" value="<?php echo set_value('title',$gallery->title);?>" id="title" class="form-control input-sm" type="text" placeholder="Enter Title" data-bv-notempty="true">
                                    </div>
                                    <div class="form-group">
                                        <label id="url">Photo Album*</label>
                                        <select name="gallery_album_id" id='gallery_album_id' class="form-control input-sm">
                                            <option value="" selected="selected"> --- Select Album --- </option>
                                            <?php $aRes = listAlbum();
                                            foreach ($aRes as $aR): ?>
                                                <option value="<?php echo $aR->gallery_album_id ?>" <?php if ($gallery->gallery_album_id==$aR->gallery_album_id) echo 'selected="selected"';?>><?php echo $aR->gallery_album_title; ?></option>
                                            <?php endforeach; ?>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <img id="output_image" src="<?php echo base_url(); ?>assets/uploads/gallery/<?php echo $gallery->photo; ?>" width="200" height="200">
                                            <input type="hidden" name="gallery_image" value="<?php echo $gallery->photo; ?>">
