    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('Admin/album_store', 'role="form" id="fromvalid"'); ?>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="gallery_album_title" id="gallery_album_title" class="form-control input-sm" type="text" placeholder="Enter Title" data-bv-notempty="true">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign"></i> Add Album</button>
